...
import type { JoinTypeStepFieldProp } from '@/components/bookGroup/create/steps/SelectJoinTypeStep/SelectJoinTypeStep';

import JoinTypeRadioCard from '@/components/bookGroup/create/steps/SelectJoinTypeStep/fields/JoinTypeRadioCard';
